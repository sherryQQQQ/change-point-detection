...
# Parameters
Z_initial_value = 80 # 5 (transient) or 80 (stationary)
...
filename = os.path.join('/Users/danielahurtado/Documents/Simulations/Data',"CoxM1_Z0{}_serv{}_t{}.pickle".format(Z_initial_value, service_rate, t0))
with open(filename, 'wb') as f:
   pickle.dump(X0, f)

filename = os.path.join('/Users/danielahurtado/Documents/Simulations/Data',"CoxM1_Z0{}_serv{}_t{}.pickle".format(Z_initial_value, service_rate, t1))
with open(filename, 'wb') as f:
   pickle.dump(X1, f)
